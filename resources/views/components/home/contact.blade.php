        ...
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <div class="flex mb-8 max-w-[370px] w-full">
                ...
                class="fill-current"
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark dark:text-gray-200 text-xl mb-1">My Location</h4>
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                ...
                class="fill-current"
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color dark:text-gray-300">+251 979321789</p>
                  </div>
               </div>
          <div class="flex mb-8 max-w-[370px] w-full">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">heamanbelay@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
              ...
              submitForm(event) {
                ...
                this.errors = {};
                  ...
                  .then(result => {
                    ...
                    this.successMessage = 'Thanks for your contact request. I will get back to you ASAP.';
                  })
