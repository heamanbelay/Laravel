    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My Name is Heaman Belay.  
              I am <span class="rounded-md text-amber-600">a Programmer</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            I am a Computer Engineering student at one of the best universities in Ethiopia, Bahirdar University. <br/>
</br> I love sharing my knowledge to others, that's why I created a
            <a
              class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary"
              href="https://www.youtube.com/channel/UCugBCkhwd-Z1czfDj93MlgA" target="_blank">YouTube Channel</a>. <br>
          </p>
          <ul class="flex flex-wrap items-center">
            <li>
              <x-components.button-link href="#portfolio" variant="primary" class="rounded-lg">
                My Projects
              </x-components.button-link>
            </li>
          </ul>
      ...
      <div class="w-full lg:w-6/12 px-4">
        <div class="lg:text-right lg:ml-auto">
          ...
          <img
              src="{{ url('/img/page1.jpg') }}"
              alt="hero"
              class="w-full lg:ml-auto"
            />
